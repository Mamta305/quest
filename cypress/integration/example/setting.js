describe('To test the setting page', () => {
    ...
    it('To edit or update the organizations details on setting page', () => {
        ...
        cy.get('.col-md-12 > .q-button-sm').type("www.googgle.com");
        //to click on button
        cy.get(".btn").click();
...
cy.log("present");
    ...
    it('to refer to integration page', () => {
        ...
        cy.get("._qInput_vtw95_80").type("asdg156");
        cy.get('._qSaveButton_vtw95_109').click();
       //to check the alert 
        cy.get('.Toastify__toast-body', { timeout: 20000 }).should('exist').contains('Connected to Segment successfully.');
        cy.log("Connected");
